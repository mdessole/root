...
if (oneapi)
  ...
  if (SYCL_COMPILER)
    ...
    if (cuda)
      ...
      set(_fsycl_targets "-fsycl-targets=nvptx64-nvidia-cuda -Xsycl-target-backend=nvptx64-nvidia-cuda --cuda-gpu-arch=sm_${CMAKE_CUDA_ARCHITECTURES} --cuda-path=${CUDA_TOOLKIT_DIR}")
    else()
